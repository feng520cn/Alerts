...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tFlash = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
            ...
            '   {footer}\n' +
            '</div>\n',
        tXj = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            '   <object data="{data}" type="{type}" width="{width}" height="{height}">\n' +
        ...
        defaultFileTypeSettings = {
            ...
            xj: function (vType, vName) {
                return (vType !== undefined && vType.match('application\/.*')) || vName.match(/\.(doc|docx|xml|conf|sh|py|xls|xlsx|ppt|js|pdf)$/i);
            },
            object: function () {
                return true;
            },
    ...
    FileInput.prototype = {
        ...
        init: function (options) {
            ...
            if (isEmpty(self.allowedPreviewTypes)) {
            	...
            	defaultPreviewTypes = self.allowedPreviewTypes;
            }
