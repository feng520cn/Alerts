+function ($) { "use strict";
  ...
  Zoom.OFFSET = 80
  Zoom._MAX_WIDTH = 1160
  Zoom._MAX_HEIGHT = 380
  ...
  Zoom.prototype._calculateZoom = function () {
    ...
    var viewportHeight = (Zoom._MAX_HEIGHT)
    var viewportWidth  = (Zoom._MAX_WIDTH)
  ...
  Zoom.prototype._triggerAnimation = function () {
    ...
    var imageCenterXoffset = $('.zoom-img-wrap').width()

    this._translateY = viewportY - imageCenterY
    this._translateX = viewportX - imageCenterX + imageCenterXoffset
